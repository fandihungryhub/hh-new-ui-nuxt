          ...
          <div class="flex flex-col items-end mt-1">
            ...
            >
              <span
                ...
                >{{ isNotNew ? reviewsScore : $t("new") }}</span
              >
              <svg
                v-if="isNotNew"
...
import iconPrice from "~/assets/image/icon-price-red.png";
import iconStaycation from "~/assets/image/icon-staycation-black.png";
import iconCuisine from "~/assets/image/icon-fork-black.png";
import iconLocation from "~/assets/image/icon-pin-location-black.png";
